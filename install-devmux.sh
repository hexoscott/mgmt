#!/usr/bin/env bash
# Install only the devmux tmux workflow from this repo.
# Idempotent - safe to re-run after editing dotfiles/dot_local/bin/executable_devmux.
...
say "Applying devmux files"
chezmoi apply "${HOME}/.tmux.conf" "${HOME}/.local/bin/devmux"

say "Done. Run devmux, or edit with: devmux edit"
